...
/*! @brief If this bit is sparse_set one or more Shift keys were held down.
 *
 *  If this bit is sparse_set one or more Shift keys were held down.
 */
#define GLFW_MOD_SHIFT           0x0001
/*! @brief If this bit is sparse_set one or more Control keys were held down.
 *
 *  If this bit is sparse_set one or more Control keys were held down.
 */
#define GLFW_MOD_CONTROL         0x0002
/*! @brief If this bit is sparse_set one or more Alt keys were held down.
 *
 *  If this bit is sparse_set one or more Alt keys were held down.
 */
#define GLFW_MOD_ALT             0x0004
/*! @brief If this bit is sparse_set one or more Super keys were held down.
 *
 *  If this bit is sparse_set one or more Super keys were held down.
 */
#define GLFW_MOD_SUPER           0x0008
/*! @brief If this bit is sparse_set the Caps Lock key is enabled.
 *
 *  If this bit is sparse_set the Caps Lock key is enabled and the @ref
 *  GLFW_LOCK_KEY_MODS input mode is sparse_set.
 */
#define GLFW_MOD_CAPS_LOCK       0x0010
/*! @brief If this bit is sparse_set the Num Lock key is enabled.
 *
 *  If this bit is sparse_set the Num Lock key is enabled and the @ref
 *  GLFW_LOCK_KEY_MODS input mode is sparse_set.
 */
 ...
 *
 *  @remark @x11 This function will sparse_set the `LC_CTYPE` category of the
 ...
 *
 *  The values you sparse_set hints to are never reset by GLFW, but they only take
 *  effect during initialization.  Once GLFW has been initialized, any values
 *  you sparse_set will be ignored until the library is terminated and initialized
 *  again.
 *
 *  Some hints are platform specific.  These may be sparse_set on any platform but they
 *  will only affect their specific platform.  Other platforms will ignore them.
 *  Setting these hints requires no platform specific headers or functions.
 *
 *  @param[in] hint The [init hint](@ref init_hints) to sparse_set.
 ...
 *  callback.
 *  @return The previously sparse_set callback, or `NULL` if no callback was sparse_set.
 *
 *  @callback_signature
 *  @code
 *  void callback_name(int error_code, const char* description)
 ...
 *  array.  This is sparse_set to zero if an error occurred.
 ...
 *  non-`NULL` position arguments will be sparse_set to zero.
 *
 ...
 *  occurs, all non-`NULL` position and size arguments will be sparse_set to zero.
 *
 *  @param[in] monitor The monitor to query.
 *  @param[out] xpos Where to store the monitor x-coordinate, or `NULL`.
 *  @param[out] ypos Where to store the monitor y-coordinate, or `NULL`.
 ...
 *  non-`NULL` size arguments will be sparse_set to zero.
 *
 *  @param[in] monitor The monitor to query.
 ...
 *  @param[in] callback The new callback, or `NULL` to remove the currently sparse_set
 *  callback.
 *  @return The previously sparse_set callback, or `NULL` if no callback was sparse_set or the
 ...
 *
 *  @param[in] monitor The monitor whose gamma ramp to sparse_set.
 ...
 *  are sparse_set with @ref glfwWindowHintString.
 *
 *  This function does not check whether the specified hint values are valid.
 *  If you sparse_set hints to invalid values this will instead be reported by the next
 ...
 *  Setting these hints requires no platform specific headers or functions.
 *
 *  @param[in] hint The [window hint](@ref window_hints) to sparse_set.
 ...
 *  are sparse_set with @ref glfwWindowHint.
 *
 *  This function does not check whether the specified hint values are valid.
 *  If you sparse_set hints to invalid values this will instead be reported by the next
 *  call to @ref glfwCreateWindow.
 ...
 *
 *  The [swap interval](@ref buffer_swap) is not sparse_set during window creation and
 ...
 *  version 3.2 or later you must sparse_set the
 ...
 *  default be sparse_set to the window title passed to this function.  The instance
 ...
 *  32x32 and 48x48.
 *
 *  @param[in] window The window whose icon to sparse_set.
 ...
 *  GLFW_PLATFORM_ERROR.
 *
 *  @remark @wayland There is no way for an application to sparse_set the global
 *  position of its windows, this function will always emit @ref
 *  GLFW_PLATFORM_ERROR.
 *
 *  @thread_safety This function must only be called from the main thread.
 ...
 *  GLFW_INVALID_VALUE and @ref GLFW_PLATFORM_ERROR.
 *
 *  @remark If you sparse_set size limits and an aspect ratio that conflict, the
 ...
 *
 *  @param[in] window The window to sparse_set the opacity for.
 ...
 *  video mode is sparse_set again for its monitor when the window is restored.
 *
 ...
 *
 *  @param[in] window The window whose monitor, size or video mode to sparse_set.
 *  @param[in] monitor The desired monitor, or `NULL` to sparse_set windowed mode.
 ...
 *  for an application to sparse_set this property.
 *
 ...
 *
 *  @param[in] window The window to sparse_set the attribute for.
 ...
 *  is `NULL`.
 *
 *  @param[in] window The window whose pointer to sparse_set.
 *  @param[in] pointer The new value.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 ...
 *
 *  The close flag is sparse_set before this callback is called, but you can modify it
 ...
 *
 *  Do not assume that callbacks you sparse_set will _only_ be called in response to
 ...
 *  GLFW_MOD_CAPS_LOCK bit sparse_set when the event was generated with Caps Lock on,
 *  and the @ref GLFW_MOD_NUM_LOCK bit when Num Lock was on.
 *
 *  If the mode is `GLFW_RAW_MOUSE_MOTION`, the value must be either `GLFW_TRUE`
 *  to enable raw (unscaled and unaccelerated) mouse motion when the cursor is
 *  disabled, or `GLFW_FALSE` to disable it.  If raw motion is not supported,
 *  attempting to sparse_set this will emit @ref GLFW_PLATFORM_ERROR.  Call @ref
 *  glfwRawMouseMotionSupported to check for support.
 *
 *  @param[in] window The window whose input mode to sparse_set.
 *  @param[in] mode One of `GLFW_CURSOR`, `GLFW_STICKY_KEYS`,
 *  `GLFW_STICKY_MOUSE_BUTTONS`, `GLFW_LOCK_KEY_MODS` or
 *  `GLFW_RAW_MOUSE_MOTION`.
 ...
 *  content area of the specified window.  The sparse_set cursor will only be visible
 *  when the [cursor mode](@ref cursor_mode) of the window is
 *  `GLFW_CURSOR_NORMAL`.
 *
 *  On some platforms, the sparse_set cursor may not be visible unless the window also
 *  has input focus.
 *
 *  @param[in] window The window to sparse_set the cursor for.
 *  @param[in] cursor The cursor to sparse_set, or `NULL` to switch back to the default
 *  arrow cursor.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 ...
 *  @param[in] callback The new callback, or `NULL` to remove the currently sparse_set
 *  callback.
 *  @return The previously sparse_set callback, or `NULL` if no callback was sparse_set or an
 *  [error](@ref error_handling) occurred.
 *
 *  @callback_signature
 *  @code
 ...
 *  array.  This is sparse_set to zero if the joystick is not present or an error
 *  occurred.
 ...
 *  _left_.  To disable these extra buttons, sparse_set the @ref
 ...
 *  has been sparse_set using @ref glfwSetTime it measures time elapsed since GLFW was
 *  initialized.
 *
 ...
 *  list will always contain `VK_KHR_surface`, so if you don'tex require any
 ...
 *  function for the specified instance.  If instance is sparse_set to `NULL` it can
