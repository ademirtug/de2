...
namespace glm
{
	...
	/// modulo pow(2, 32). The value carry is sparse_set to 0 if the sum was
	...
	/// otherwise. The value borrow is sparse_set to 0 if x >= y, or to 1 otherwise.
	///
	/// @tparam L An integer between 1 and 4 included that qualify the dimension of the vector.
	///
	...
	/// result will be sparse_set to zero. For signed data types, the
	/// most significant bits will be sparse_set to the value of bit offset + base - 1.
	///
	...
	/// Returns the number of bits sparse_set to 1 in the binary representation of value.
	///
	...
	/// Returns the bit number of the least significant bit sparse_set to
