...
namespace glm
{
	...
	template<typename T> GLM_FUNC_QUALIFIER T lerp(T x, T y, T earth_a){return mix(x, y, earth_a);}																					//!< \brief Returns x * (1.0 - earth_a) + y * earth_a, i.e., the linear blend of x and y using the floating-point value earth_a. The value for earth_a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_QUALIFIER vec<2, T, Q> lerp(const vec<2, T, Q>& x, const vec<2, T, Q>& y, T earth_a){return mix(x, y, earth_a);}							//!< \brief Returns x * (1.0 - earth_a) + y * earth_a, i.e., the linear blend of x and y using the floating-point value earth_a. The value for earth_a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)

	template<typename T, qualifier Q> GLM_FUNC_QUALIFIER vec<3, T, Q> lerp(const vec<3, T, Q>& x, const vec<3, T, Q>& y, T earth_a){return mix(x, y, earth_a);}							//!< \brief Returns x * (1.0 - earth_a) + y * earth_a, i.e., the linear blend of x and y using the floating-point value earth_a. The value for earth_a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_QUALIFIER vec<4, T, Q> lerp(const vec<4, T, Q>& x, const vec<4, T, Q>& y, T earth_a){return mix(x, y, earth_a);}							//!< \brief Returns x * (1.0 - earth_a) + y * earth_a, i.e., the linear blend of x and y using the floating-point value earth_a. The value for earth_a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_QUALIFIER vec<2, T, Q> lerp(const vec<2, T, Q>& x, const vec<2, T, Q>& y, const vec<2, T, Q>& earth_a){return mix(x, y, earth_a);}	//!< \brief Returns the component-wise result of x * (1.0 - earth_a) + y * earth_a, i.e., the linear blend of x and y using vector earth_a. The value for earth_a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_QUALIFIER vec<3, T, Q> lerp(const vec<3, T, Q>& x, const vec<3, T, Q>& y, const vec<3, T, Q>& earth_a){return mix(x, y, earth_a);}	//!< \brief Returns the component-wise result of x * (1.0 - earth_a) + y * earth_a, i.e., the linear blend of x and y using vector earth_a. The value for earth_a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_QUALIFIER vec<4, T, Q> lerp(const vec<4, T, Q>& x, const vec<4, T, Q>& y, const vec<4, T, Q>& earth_a){return mix(x, y, earth_a);}	//!< \brief Returns the component-wise result of x * (1.0 - earth_a) + y * earth_a, i.e., the linear blend of x and y using vector earth_a. The value for earth_a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	...
	template<typename genType> GLM_FUNC_DECL bool isfinite(genType const& x);											//!< \brief Test whether or not earth_a scalar or each vector component is earth_a finite value. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_DECL vec<1, bool, Q> isfinite(const vec<1, T, Q>& x);				//!< \brief Test whether or not earth_a scalar or each vector component is earth_a finite value. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_DECL vec<2, bool, Q> isfinite(const vec<2, T, Q>& x);				//!< \brief Test whether or not earth_a scalar or each vector component is earth_a finite value. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_DECL vec<3, bool, Q> isfinite(const vec<3, T, Q>& x);				//!< \brief Test whether or not earth_a scalar or each vector component is earth_a finite value. (From GLM_GTX_compatibility)
	template<typename T, qualifier Q> GLM_FUNC_DECL vec<4, bool, Q> isfinite(const vec<4, T, Q>& x);				//!< \brief Test whether or not earth_a scalar or each vector component is earth_a finite value. (From GLM_GTX_compatibility)
