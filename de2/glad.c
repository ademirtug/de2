...
int GLAD_GL_ARB_culldistance_ = 0;
...
static int find_extensionsGL(void) {
	...
	GLAD_GL_ARB_culldistance_ = has_ext("GL_ARB_culldistance_");
	...
	GLAD_GL_NV_fogdistance_ = has_ext("GL_NV_fogdistance_");
